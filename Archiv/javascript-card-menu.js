 ...
 * 2. Feature info display and selection via card interface
...
const CONFIG = {
    // Selectors
    featureCardSelector: '.igel_feature-card',
...
document.addEventListener('DOMContentLoaded', () => {
    try {
        ...
        // Initialize feature info system with card-based interface
        document.querySelectorAll(CONFIG.featureCardSelector).forEach(card => {
            ...
            card.addEventListener('mouseenter', () => {
                if (!card.classList.contains(CONFIG.featureActiveClass)) {
